...
#warning You're compiling in the SavePropValues-Mode. This is a mode intended for Debugging and nothing else. It's cool to take a (entity-)dump here to find out how things work, but don't use this in production
    ...
    public class DemoParser : IDisposable
    {
        ...
        /// </summary>
        public event EventHandler<OtherDeathEventArgs> OtherDeath;
        ...
        internal bool RoundStartThisTick = false;

        internal List<int> EntitiesCreatedThisTick = new List<int>();
        ...
        /// </summary>
        internal EntityInfo[] RawEntities = new EntityInfo[MAX_ENTITIES]; //Max 2048 entities. 
        ...
        public bool ParseNextTick()
        {
            ...
            foreach (int newEntityId in EntitiesCreatedThisTick)
            {
                EntitySpawnedEventArgs args = new EntitySpawnedEventArgs();
                args.ID = newEntityId;
                args.Entity = EntityDict[newEntityId];

                RaiseEntitySpawned(args);
            }
            EntitiesCreatedThisTick.Clear();
        ...
        {
            SendTableParser.FindByName("CChicken")
                .OnNewEntity += (object sender, EntityCreatedEventArgs e) => HandleNewEntity(e);

            SendTableParser.FindByName("CChicken")
                .OnDestroyEntity += (object sender, EntityDestroyedEventArgs e) => HandleDestroyEntity(e);


            SendTableParser.FindByName("CPropDoorRotating")
                .OnNewEntity += (object sender, EntityCreatedEventArgs e) => HandleNewEntity(e);
            ...
            SendTableParser.FindByName("CPhysicsPropMultiplayer")
                .OnNewEntity += (object sender, EntityCreatedEventArgs e) => HandleNewEntity(e);
            ...
            SendTableParser.FindByName("CDynamicProp")
                .OnNewEntity += (object sender, EntityCreatedEventArgs e) => HandleNewEntity(e);
            ...
            SendTableParser.FindByName("CBaseEntity")
                .OnNewEntity += (object sender, EntityCreatedEventArgs e) => HandleNewEntity(e);
        ...
        private void HandleNewEntity(EntityCreatedEventArgs e)
        {
            Entity entity = new Entity();
            if (EntityDict.ContainsKey(e.Entity.ID))
                entity = EntityDict[e.Entity.ID];
            else
                EntityDict.Add(e.Entity.ID, entity);
            ...
            switch (e.Class.Name)
            {
                ...
                case "CPropDoorRotating":
                    entity.Type = EntityType.PropDoorRotating;
                    break;
                case "CPhysicsPropMultiplayer":
                    entity.Type = EntityType.PhysicsPropMultiplayer;
                    break;
                case "CDynamicProp":
                    entity.Type = EntityType.Dynamic;
                    break;
                case "CBaseEntity":
            ...
            if (!EntitiesCreatedThisTick.Contains(e.Entity.ID))
                EntitiesCreatedThisTick.Add(e.Entity.ID);

            entity.ID = e.Entity.ID;

            e.Entity.FindProperty("m_nModelIndex").IntRecived += (xx, update) =>
            {
                entity.ModelIndex = update.Value;
                entity.ModelLocation = modelprecache[update.Value];
            };
            e.Entity.FindProperty("m_angRotation").VectorRecived += (xx, update) =>
            {
                entity.Rotation = update.Value;
            };
            e.Entity.FindProperty("m_vecOrigin").VectorRecived += (xx, update) =>
            {
                entity.LocalPosition = update.Value;
            };
            e.Entity.FindProperty("m_cellX").IntRecived += (xx, update) =>
            {
                entity.CellX = update.Value;
            };
            e.Entity.FindProperty("m_cellY").IntRecived += (xx, update) =>
            {
                entity.CellY = update.Value;
            };
            e.Entity.FindProperty("m_cellZ").IntRecived += (xx, update) =>
            {
                entity.CellZ = update.Value;
            };
        }

        private void HandleDestroyEntity(EntityDestroyedEventArgs e)
        {
            Entity entity = null;
            if (EntityDict.ContainsKey(e.Entity.ID))
                entity = EntityDict[e.Entity.ID];
            ...
            RaiseEntityRemoved(args);

            EntityDict.Remove(e.Entity.ID);
        }
        ...
        private void HandleNewPlayer(EntityInfo playerEntity)
        {
            Player p = null;
            ...
            //Custom
            playerEntity.FindProperty("localdata.m_vecViewOffset[0]").FloatRecived += (sender, e) => p.ViewOffset.X = e.Value;
        ...
        internal void RaiseOtherDeath(OtherDeathEventArgs death)
        {
            if (OtherDeath != null)
                OtherDeath(this, death);
        }
        ...
        internal void RaiseEntitySpawned(EntitySpawnedEventArgs args)
        {
            if (EntitySpawned != null)
                EntitySpawned(this, args);
        }

        internal void RaiseEntityRemoved(EntityRemovedEventArgs args)
        {
            if (EntityRemoved != null)
                EntityRemoved(this, args);
        }
